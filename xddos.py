...
# ---------- Auto‑Update (Always Updates on Every Run) ----------
def update_self():
    """
    Always download the latest script from GitHub, overwrite current,
    and restart with a flag to avoid loop.
    """
    # If we are already the updated version, skip update
    ...
    try:
        ...
        # Restart with the new script, adding the --updated flag
...
def main():
    ...
    # If we reach here, either update failed or we are the latest version
    verify_user()
